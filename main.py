...
def get_transcript_single(link):
        """
            Run Transcript Actor for a single link.
                Returns transcript text string (empty string if failed).
                    """
        run_input = {
            "startUrls": [{"url": link}],
        }
...
def label_with_claude(description, keyword_description):
        """
            Use Claude API to judge whether the video description is related to keyword_description.
                Returns 'yes' or 'Non'.
                    """
